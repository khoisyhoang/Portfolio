  ...
  return (
    <>
      <button
        ...
        onClick={onToggleNav}
        className="sm:hidden dark:bg-primary-bg bg-secondary-bg border dark:border-zinc-800 border-zinc-200 rounded-md sm:p-2 p-1"
      >
        <RxHamburgerMenu className="text-md" />
      </button>
      <div
