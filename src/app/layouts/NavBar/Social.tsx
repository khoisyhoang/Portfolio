...
export default function Social() {
  return (
    <>
      ...
      {/* Responsive Mobile Connect button */}
      <div className="lg:hidden">
        <DropdownMenu>
          ...
          <DropdownMenuPortal>
            <DropdownMenuContent
              className="w-56 p-2 bg-background/95 backdrop-blur-md border border-border/50 shadow-xl rounded-xl animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 z-[9999] relative"
              sideOffset={8}
              align="end"
            >
